...
Authors: 
  - [ZZZKROSS](https://github.com/ZZZKROSS): Hue Install/Config/Start/Stop via Ambari
...
sudo git clone https://github.com/ZZZKROSS/ambari-hue-service.git /var/lib/ambari-server/resources/stacks/HDP/$VERSION/services/HUE
```
